...
def applicable_matrix(
    ...
    *,
    ...
    combinations (e.g. GP on DSI, DKI on single-shell, B-Spline on dMRI
    data) are excluded here rather than spawning empty CI jobs. Returns
    one dict per runnable cell, suitable for a GitHub Actions
