...
img_data = load_api(dwi_fname, nb.Nifti1Image).get_fdata()
...
def test_plot_volumewise_motion(request, tmp_path):
    ...
    fig = plot_volumewise_motion(frames, motion_params)
...
def test_plot_framewise_displacement(request, tmp_path):
    ...
    fig = plot_framewise_displacement(fd1, fd2, label1, label2)
